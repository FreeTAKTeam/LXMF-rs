...
report = {
    "status": status,
    "evidence_scope": "software_fake_tcp_rnode_multi",
    "product_boundary": (
        "This proves the RNodeMulti TCP parent software path, startup probe, "
        "runtime status, and vport management dispatch against a local fake "

...
def build_bundle(
    ...
    return {
        ...
        "readiness_axes": {
            "rns_1_5_2_software_parity": parity_readiness(parity),
...
def render_markdown(bundle: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "| Axis | Result |",
            "|---|---|",
            f"| RNS 1.5.2 software parity | {bundle['readiness_axes']['rns_1_5_2_software_parity']['complete']} / {bundle['readiness_axes']['rns_1_5_2_software_parity']['applicable']} PASS |",

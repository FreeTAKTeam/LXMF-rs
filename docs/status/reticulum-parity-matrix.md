...
alive for later adopted devices. It still needs broader explicit daemon-owned
shutdown hardening for dynamically spawned listeners and prepared-host
interface churn evidence.

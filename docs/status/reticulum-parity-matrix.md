...
#610 row remains partial because broader timeout/reconnect and file-adapter
fault coverage are not yet proven; the pinned-Python suite now proves cancellation

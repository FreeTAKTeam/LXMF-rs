...
The production serial stream worker also has a deterministic duplex regression
for wrong-key rejection and authenticated ingress/egress. These supplement
(but do not replace) the pinned Python/Rust TCP and UDP traces; physical-device

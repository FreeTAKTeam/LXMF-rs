...
local disk-failure check, client-cancellation check, and concurrent-client
check, and interrupted-link/status-output check are evidence for that slice only

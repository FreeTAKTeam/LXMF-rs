...
- Valid empty inbound propagation offers now return Python's "wants none"
  response after peering-key validation without admitting the remote peer or
  queuing local propagation payloads for it.

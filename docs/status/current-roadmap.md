...
failure-category checks, path-discovery-timeout check, and listener restart
check are evidence for that slice only and do not promote the broader utility

...
pub(super) struct TcpServerSelection {
    ...
    pub(super) block_fast_flapping: Option<bool>,
    pub(super) fast_flapping_threshold: Option<f64>,
    pub(super) fast_flapping_grace: Option<u64>,
    pub(super) fast_flapping_block_time: Option<f64>,
...
pub(super) fn select_tcp_server_bind(
    ...
    if let Some(addr) = args.transport.as_ref() {
        return Ok(TcpServerSelection {
            ...
            prefer_ipv6: false,
            i2p_tunneled: false,
            block_fast_flapping: None,
            fast_flapping_threshold: None,
            fast_flapping_grace: None,
            fast_flapping_block_time: None,
    ...
    for (index, iface) in config.interfaces.iter().enumerate() {
        ...
        matches.push(TcpListenerMatch {
            ...
            block_fast_flapping: iface.block_fast_flapping,
            fast_flapping_threshold: iface.fast_flapping_threshold,
            fast_flapping_grace: iface.fast_flapping_grace,
            fast_flapping_block_time: iface.fast_flapping_block_time,
    ...
    if selected.kind == "local" && tcp_bind_addr_is_in_use(&selected.bind_addr) {
        return Ok(TcpServerSelection {
            ...
            block_fast_flapping: selected.block_fast_flapping,
            fast_flapping_threshold: selected.fast_flapping_threshold,
            fast_flapping_grace: selected.fast_flapping_grace,
            fast_flapping_block_time: selected.fast_flapping_block_time,

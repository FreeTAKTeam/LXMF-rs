const SDK_OPERATION_SPECS: &[SdkOperationSpec] = &[
    ...
    SdkOperationSpec {
        ...
        kind: "command",
        transport_variant: "rpc",
        description: "Generate a paper-message URI envelope for an outbound message.",
        aliases: &["sdk_paper_encode_v2"],
        required_capabilities: &["sdk.capability.paper_messages"],
        rpc_method: "sdk_paper_encode_v2",
    },
    SdkOperationSpec {
        id: "app.paper.decode",
        group: "paper",
        kind: "command",
        transport_variant: "rpc",
        description: "Decode and ingest a paper-message URI envelope.",
        aliases: &["sdk_paper_decode_v2"],
        required_capabilities: &["sdk.capability.paper_messages"],
        rpc_method: "sdk_paper_decode_v2",
    },
    SdkOperationSpec {

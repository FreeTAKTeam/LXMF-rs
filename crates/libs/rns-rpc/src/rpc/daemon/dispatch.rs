            ...
            "daemon_status_ex" => {
                ...
                Ok(RpcResponse {
                    ...
                    result: Some(json!({
                        ...
                        "worker_processes": snapshot.worker_processes,
                        "interface_worker_processes": snapshot.interface_worker_processes,
                        "control_router_processes": snapshot.control_router_processes,

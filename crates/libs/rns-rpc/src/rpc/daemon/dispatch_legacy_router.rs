impl RpcDaemon {
    fn handle_rpc_legacy(&self, request: RpcRequest) -> Result<RpcResponse, std::io::Error> {
        match request.method.as_str() {
            ...
            "get_delivery_policy" | "set_delivery_policy" | "propagation_status" | "propagation_enable" | "propagation_ingest" | "propagation_fetch" | "get_outbound_propagation_node" | "set_outbound_propagation_node" | "list_propagation_nodes" | "propagation_remote_status" | "propagation_remote_sync" | "propagation_remote_unpeer" => self.handle_rpc_legacy_propagation(request),

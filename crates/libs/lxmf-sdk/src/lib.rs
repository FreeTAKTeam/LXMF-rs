...
pub use domain::{
    ...
    PropagationDeliveryPolicyResult, PropagationEnableRequest, PropagationNodeListResult,
    PropagationNodeSelectionResult, PropagationNodeSetRequest, PropagationPeerMaintenanceResult,

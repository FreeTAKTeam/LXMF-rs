...
pub use domain::{
    ...
    PropagationNodeListResult, PropagationNodeRecord, PropagationNodeSelectionResult,
    PropagationNodeSelectionState, PropagationNodeSetRequest, PropagationPeerMaintenanceResult,
    PropagationPeerSyncRequest, PropagationPeerSyncResult, PropagationRecoveryStateResult,

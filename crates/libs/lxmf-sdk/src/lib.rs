...
pub use domain::{
    ...
    PropagationAcknowledgeSyncResult, PropagationNodeListResult, PropagationNodeSelectionResult,
    PropagationNodeSetRequest, PropagationPeerSyncRequest, PropagationPeerSyncResult,

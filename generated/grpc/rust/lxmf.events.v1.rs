...
pub mod event_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn poll_events(
            &mut self,
            request: impl tonic::IntoRequest<super::PollEventsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PollEventsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("lxmf.events.v1.EventService", "PollEvents"));
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("lxmf.events.v1.EventService", "SubscribeEvents"),
                );
...
pub mod event_service_server {
    ...
    pub trait EventService: std::marker::Send + std::marker::Sync + 'static {
        async fn poll_events(
            &self,
            request: tonic::Request<super::PollEventsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PollEventsResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/lxmf.events.v1.EventService/PollEvents" => {
                    ...
                    struct PollEventsSvc<T: EventService>(pub Arc<T>);
                    impl<
                        T: EventService,
                    > tonic::server::UnaryService<super::PollEventsRequest>
                    for PollEventsSvc<T> {
                        type Response = super::PollEventsResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as EventService>::poll_events(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = PollEventsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                ...
                "/lxmf.events.v1.EventService/SubscribeEvents" => {
                    #[allow(non_camel_case_types)]
                    struct SubscribeEventsSvc<T: EventService>(pub Arc<T>);
                    impl<
                        T: EventService,
                    ...
                    > for SubscribeEventsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EventService>::subscribe_events(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "lxmf.events.v1.EventService";

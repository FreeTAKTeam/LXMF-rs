...
pub mod delivery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn send(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("lxmf.delivery.v1.DeliveryService", "Send"));
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("lxmf.delivery.v1.DeliveryService", "GetStatus"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn cancel(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("lxmf.delivery.v1.DeliveryService", "Cancel"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod delivery_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/lxmf.delivery.v1.DeliveryService/Send" => {
                    ...
                    struct SendSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    > tonic::server::UnaryService<super::SendRequest> for SendSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as DeliveryService>::send(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/lxmf.delivery.v1.DeliveryService/GetStatus" => {
                    #[allow(non_camel_case_types)]
                    struct GetStatusSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    ...
                    for GetStatusSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::get_status(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/lxmf.delivery.v1.DeliveryService/Cancel" => {
                    #[allow(non_camel_case_types)]
                    struct CancelSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    ...
                    for CancelSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::cancel(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "lxmf.delivery.v1.DeliveryService";

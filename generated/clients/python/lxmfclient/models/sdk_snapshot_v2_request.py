...
class SdkSnapshotV2Request(BaseModel):
    """
    ...
    def method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['sdk_snapshot_v2']):
            raise ValueError("must be one of enum values ('sdk_snapshot_v2')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": SdkSnapshotV2Params.from_dict(obj["params"]) if obj.get("params") is not None else None
        })

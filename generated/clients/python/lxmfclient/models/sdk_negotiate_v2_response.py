...
class SdkNegotiateV2Response(BaseModel):
    """
    SdkNegotiateV2Response
    """ # noqa: E501
    id: RpcId
    jsonrpc: Optional[StrictStr] = None
    result: SdkNegotiateV2Result
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": SdkNegotiateV2Result.from_dict(obj["result"]) if obj.get("result") is not None else None
        })

...
class SdkPollEventsV2Result(BaseModel):
    """
    SdkPollEventsV2Result
    """ # noqa: E501
    dropped_count: Annotated[int, Field(strict=True, ge=0)]
    events: List[Dict[str, Any]]
    next_cursor: Annotated[str, Field(min_length=1, strict=True)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["dropped_count", "events", "next_cursor"]

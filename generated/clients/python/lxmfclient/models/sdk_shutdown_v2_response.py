...
class SdkShutdownV2Response(BaseModel):
    """
    SdkShutdownV2Response
    """ # noqa: E501
    id: RpcId
    jsonrpc: Optional[StrictStr] = None
    result: SdkShutdownV2Result
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": SdkShutdownV2Result.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
